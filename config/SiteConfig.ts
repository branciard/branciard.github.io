export default {
  ...
  siteTitle: 'Francois Branciard', // Navigation and Site Title
  siteTitleAlt: 'Francois Branciard Website', // Alternative Site title for SEO
  ...
  siteDescription: 'Francois Branciard Website', // Your site description
